...
system administrator.""".format(
              "please reinstall the 10X refdata\ntar file on " if known_genome else
              "please reindex your reference\nusing the mkref tool",
...
def check_sample_indices(sample_item, sample_index_key = "sample_indices"):
    ...
    for sample_index in sample_indices:
        ...
        elif tk_constants.SAMPLE_DUAL_INDEX_MAP.get(sample_index):
            # pluck out the i7 index
            new_sample_indices.append(tk_constants.SAMPLE_DUAL_INDEX_MAP.get(sample_index)[0])
