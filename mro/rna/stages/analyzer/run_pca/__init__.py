...
def split(args):
    ...
    num_pcs = analysis_constants.PCA_N_COMPONENTS_DEFAULT if args.num_pcs is None else args.num_pcs

    irlb_mem_gb = cr_pca.get_irlb_mem_gb_from_matrix_dim(nonzero_entries, feature_dim, bcs_dim, num_pcs)
