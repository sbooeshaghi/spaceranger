...
import collections
import os
from cellranger.rna.library import GENE_EXPRESSION_LIBRARY_TYPE, LIBRARY_TYPE
...
SUBSAMPLE_TARGETED_FIXED_DEPTHS = [100, 250, 500, 1000, 2500, 5000, 10000,
                                   15000, 20000, 30000, 40000, 50000]
#  - for all other libraries
SUBSAMPLE_FIXED_DEPTHS = [5000, 20000, 50000]
