...
import numpy as np
from cellranger.spatial.pycpd.expectation_maximization_registration import expectation_maximization_registration
...
class affine_registration(expectation_maximization_registration):
    ...
    def update_variance(self):
        ...
        self.MSE = (xPx - 2 * trAB + trBYPYP) / (2 * self.sigma2)
