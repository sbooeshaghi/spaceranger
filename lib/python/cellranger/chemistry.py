...
# Single Cell Feature-Barcdoing only
CHEMISTRY_SC_FB = {
    'name': 'SC-FB',
...
DEFINED_CHEMISTRIES = SC3P_CHEMISTRIES + [CHEMISTRY_SCVDJ, CHEMISTRY_SCVDJ_R2] + SC5P_CHEMISTRIES + [CHEMISTRY_SC_FB] + [CHEMISTRY_SPATIAL3P_V1]
...
def check_chemistry_defs():
    ...
    names = [chem['name'] for chem in DEFINED_CHEMISTRIES]
